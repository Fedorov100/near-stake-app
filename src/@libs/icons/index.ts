...
import { ReactComponent as NearWalletIcon } from './assets/NearWallet.svg';
...
export const NearWallet = createMaterialIcon(NearWalletIcon);
export const Swap = createMaterialIcon(SwapIcon);
